...
echo "func/capacity_table";cd; cd $HOME_DIR/lib/func/capacity;racket capacity-dic-test.rkt
echo "func/capacity_table";cd; cd $HOME_DIR/lib/func/capacity;racket capacity-func-test.rkt
