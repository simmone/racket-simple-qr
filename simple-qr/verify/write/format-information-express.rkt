...
(define-runtime-path s8_format_information_directory "../express/content/docs/s8_format_information")
(define-runtime-path index_md_file "../express/content/docs/s8_format_information/_index.md")
