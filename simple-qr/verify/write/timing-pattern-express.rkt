...
(define-runtime-path s5_timing_pattern_directory "../express/content/docs/s5_timing_pattern")
(define-runtime-path index_md_file "../express/content/docs/s5_timing_pattern/_index.md")
