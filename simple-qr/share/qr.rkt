...
(provide (contract-out
          [struct QR
                  (
                   ...
                   (point_type_map (hash/c (cons/c natural? natural?) (or/c 'finder 'separator 'timing 'alignment 'dark 'format 'version)))
                   (matrix MATRIX?)
                   (one_color string?)
          ...
          [add-point (-> (cons/c natural? natural?) (or/c 0 1) (or/c 'finder 'separator 'timing 'alignment 'dark 'format 'version) QR? void?)]
          [fill-type-points (-> (or/c 'finder 'separator 'timing 'alignment 'dark 'format 'version) (cons/c string? string?) QR? void?)]
